...
export const metadata: Metadata = {
  ...
  description:
    "Grab the free guide. The five documents that actually shaped how serious people think about where AI is going, with an honest verdict on each. Enter your email and it unlocks right here.",
};

export default function EssaysPage() {
  const guide = getResource("the-five-ai-essays");
  if (!guide) notFound();
          ...
          <div className="mb-10">
            ...
            <h1 className="font-serif text-4xl md:text-6xl font-medium text-warm-text leading-tight mb-6">
              <span className="bg-warm-accent/25 [box-decoration-break:clone] [-webkit-box-decoration-break:clone] rounded-[4px] px-2 py-0.5 -mx-1 leading-[1.35]">
                The Five AI Essays Worth Reading
              </span>
            </h1>
            <p className="text-lg text-warm-muted leading-relaxed">
              The five documents that actually shaped how serious people think
              about where AI is going. Each one with a bio, a reading time, and an
              honest verdict on where it holds up. Drop your email and it unlocks
              right here.
            </p>
          </div>
