...
export default function RoutinePage() {
  const guide = getResource("the-ai-accountability-check-in");
  if (!guide) notFound();
        ...
        <div className="rounded-2xl border border-warm-border/70 bg-cream/70 backdrop-blur-md shadow-[0_10px_40px_-12px_rgba(28,25,23,0.13)] p-8 md:p-12">
          <div className="mb-10">
            ...
            <p className="text-lg text-warm-muted leading-relaxed">
              A Claude Code routine that pulls your calendar and Slack DMs you a
              midday check-in every weekday. Runs in the cloud. Fires even when
              your laptop is closed. Drop your email and it unlocks right here.
            </p>
          </div>
