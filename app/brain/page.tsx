...
export const metadata: Metadata = {
  ...
  description:
    "Grab the free guide. The exact system I use to run my company. Enter your email and it unlocks right here.",
};

export default function BrainPage() {
  const guide = getResource("the-ai-second-brain");
  if (!guide) notFound();
        ...
        <div className="rounded-2xl border border-warm-border/70 bg-cream/70 backdrop-blur-md shadow-[0_10px_40px_-12px_rgba(28,25,23,0.13)] p-8 md:p-12">
          <div className="mb-10">
            ...
            <p className="text-lg text-warm-muted leading-relaxed">
              The exact system I use to run my company. Your notes, your context,
              and your decisions in one place that actually thinks with you. Drop
