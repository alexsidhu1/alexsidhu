...
export const metadata: Metadata = {
  ...
  description:
    "One file, five minutes. Set your tone and banned words in Claude Code and every email it drafts sounds like you wrote it. Enter your email and it unlocks right here.",
};
        ...
        <div className="rounded-2xl border border-warm-border/70 bg-cream/70 backdrop-blur-md shadow-[0_10px_40px_-12px_rgba(28,25,23,0.13)] p-8 md:p-12">
          <div className="mb-10">
            ...
            <p className="text-lg text-warm-muted leading-relaxed">
              One file, five minutes. Set your tone, your banned words, and your
              sentence rhythm in Claude Code — and every email it drafts from
              then on sounds like you wrote it. Drop your email and it unlocks
              right here.
            </p>
          </div>
