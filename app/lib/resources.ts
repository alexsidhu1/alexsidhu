...
Built by Alex Sidhu, Whitehorse AI.`,
  },
  {
    ...
    date: "2026-08-28",
    excerpt:
      "The free skill that stops your AI burying the answer. Action first, numbered steps, no \"Great question!\" Two minutes to install, and the full text is here if you would rather paste a file than install a plugin.",
    highlights: [
      "The two commands that install it, plus the versions for Cursor, Codex, Gemini and Zed",
      "The full skill text, so you can paste it in yourself instead of installing anything",
      "The ten rules and why each one exists, including the one I would have skipped",
      "How to fork it into your own house style in about twenty minutes",
    ],
...
| 7. Make completed work visible | Wins buried in a recap |
| 8. Matter-of-fact tone for problems | "Uh oh, there seems to be an issue" |
...
Here it is, all of it. This is what gets loaded when you type the command.

If you'd rather not install a plugin at all, save this as \`~/.claude/skills/i-have-adhd/SKILL.md\` and it works the same way. Same for \`~/.cursor/skills/\` on Cursor, or \`~/.config/zed/skills/\` on Zed.
...
MIT licensed, by Ayoub G. Repo is at [github.com/ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd). Fork it, edit it, ship it, no permission needed.

## Fork it into your own house style

You've probably noticed every example above is code. That's the upstream flavour, and it's the one weakness for anyone whose work isn't in a terminal.
...
1. Fork the repo on GitHub, or just copy the text above into your own \`SKILL.md\`
