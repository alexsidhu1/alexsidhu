...
export const metadata: Metadata = {
  ...
  description:
    "Grab the free guide. The skill that stops your AI burying the answer: action first, numbered steps, no \"Great question!\" Two minutes to install. Enter your email and it unlocks right here.",
};

export default function RitalinPage() {
  const guide = getResource("the-adhd-skill");
  if (!guide) notFound();
